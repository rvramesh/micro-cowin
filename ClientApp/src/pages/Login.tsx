            ...
            <div className="flex flex-col overflow-y-auto md:flex-row dark:bg-gray-800">
              <div className="h-auto md:w-1/2 p-6 pb-0">
                ...
                <p className="pb-4 text-gray-700 dark:text-gray-200">
                  ...
                  They can express their interest for a vaccine and their
                  convient date. The system will place the users in a queue. As
                  the vaccines become available, a slot will be blocked based on
                  first expressed interest, first served basis and the system
                  will send a notification via Telegram app to inform when they
                  can visit for vaccination.
                </p>
                <p className="pb-4 text-gray-700 dark:text-gray-200">
                  This is not a replacement for GOI's CoWin system. This helps
                  in managing the tokens for the user and in anticipating the
                  demand to plan for the vaccination drive at a individual
                  center level.
                </p>
                <p className="pb-4 text-gray-700 dark:text-gray-200">
                  <a
                ...
                <p className="pb-4 text-gray-700 dark:text-gray-200">
                  ...
                  {organizingBodyName} but is interested in this application,
                  you can visit the source code @{" "}
                  <a
                    className="font-semibold text-purple-600 dark:text-purple-400 hover:underline"
                    href={sourceUrl}
                  >
